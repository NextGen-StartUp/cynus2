  ...
  return (
    <>
      <div className="background-dark">
        <Head>
          <title>CYNUS 3D Maus- Fully Flexible Configurable PC Mouse for Increased Productivity</title>
          <meta charSet="UTF-8"/>
          <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
          <meta name="description" content="CYNUS 3D Maus: THE FIRST FULLY FLEXIBLE CONFIGURABLE OPEN SPACE PC MOUSE"/>
