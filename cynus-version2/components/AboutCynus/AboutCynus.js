  ...
  return (
      ...
      <div className="background-dark">
        <div className="grid-container flex-center full-height">
          ...
          <br />
          <br />
            <h2>We deliver &quot;The smartest way to control your device&quot; and perfect the human-application communication with our product. For the first time, the user is able to control their software application on the PC with only one input device. The intuitive use and smart features enable more efficient work and thus cost savings. On top, the high level of ergonomics contributes to the user&apos;s health.
              <br />
              <br />
